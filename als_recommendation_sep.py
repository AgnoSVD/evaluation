    ...
    def train(self):
        ...
        while True:
            ...
            if epoch == self.max_epoch:
                break
            prev_risk = risk
        # print(f"converged at rmse: {self.calc_risk(self.X)}, epoch: {epoch}")
        # duration = time.time() - start_time
        # end_cpu_usage = process.cpu_times()
        # end_memory_usage = process.memory_info()
        # print("ALS -> Duration:", duration,
        #       " userDiff:", (end_cpu_usage.user - start_cpu_usage.user) * 1e6,
        #       " sysDiff:", (end_cpu_usage.system - start_cpu_usage.system) * 1e6,
        #       " rss:", (end_memory_usage.rss - start_memory_usage.rss) / 1024**2, "MB")
